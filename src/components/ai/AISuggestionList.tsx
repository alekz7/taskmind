      ...
      {isLoading ? (
        <div className="flex-1 flex items-center justify-center">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-gray-500">Generating AI suggestions...</span>
          </div>
        </div>
        ...
        >
          ...
          <p className="text-xs text-gray-400 mt-1">Add more tasks to get personalized recommendations</p>
        </motion.div>
      ) : (
